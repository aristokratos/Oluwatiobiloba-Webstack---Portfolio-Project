    ...
    >
      <div className="max-w-screen-lg p-4 mx-auto flex flex-col justify-center w-full h-full">
        ...
        I am a skilled full-stack software engineer proficient in a range of programming languages, including C#, JavaScript, ReactJS, Python, and C. 
          ...
          I am well-equipped to tackle challenging projects and deliver exceptional results. Additionally, I possess strong communication and collaboration skills, working effectively with cross-functional teams to achieve project success. 
          I understand that effective communication is crucial for creating a productive and efficient work environment.
